...
export default function ExpertImportModal({ isOpen, onClose, onImport }: ExpertImportModalProps) {
  ...
  const handleDownloadTemplate = () => {
    ...
    XLSX.writeFile(wb, `专家导入模板_${new Date().toLocaleDateString('zh-CN')}.xlsx`);
        ...
        <div className="p-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
            ...
            <ul className="text-sm text-blue-800 dark:text-blue-400 space-y-1">
              ...
              <li>• 必填字段：姓名、手机号、专业领域</li>
              <li>• 如果手机号已存在，该条记录将被跳过</li>
              <li>• 费用字段请填写数字，不要包含货币符号</li>
